...
type RunState struct {
	...
	// Set by writeApprovalGate alongside PendingToolCalls — identify the
	// real approvals row, letting engine.go enrich EventApprovalRequired
	// without needing a Gateway dependency itself.
